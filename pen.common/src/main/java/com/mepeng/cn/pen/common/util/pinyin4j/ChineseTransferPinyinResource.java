...
class ChineseTransferPinyinResource
{
    /**
     ...
     */
    private ChineseTransferPinyinResource()
    {
        initializeResource();
    }
    ...
    private void initializeResource()
    {
        try
        {
            ...
            getUnicodeToHanyuPinyinTable().load(ResourceAide.getResourceInputStream(resourceName));
     ...
     */
    static ChineseTransferPinyinResource getInstance()
    {
    ...
    {
        static final ChineseTransferPinyinResource theInstance = new ChineseTransferPinyinResource();
    }
