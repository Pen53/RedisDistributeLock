...
public class PinyinAide
{
     ...
     * 
     */
    static public String[] toChinesePinyinStringArray(char ch)
    {
     ...
     * 
     * @see ChinesePinyinOutputFormat
     * @see ChinesePinyinOutputFormatCombinationException
     * 
     */
    static public String[] toChinesePinyinStringArray(char ch,
            ...
            throws ChinesePinyinOutputFormatCombinationException
    {
        ...
        if (null != pinyinStrArray)
        {
            ...
            {
                pinyinStrArray[i] = PinyinConverter.formatHanyuPinyin(pinyinStrArray[i], outputFormat);
            }
    ...
    {
        return ChineseTransferPinyinResource.getInstance().getHanyuPinyinStringArray(ch);
    }
    ...
    /*private static String[] convertToGwoyeuRomatzyhStringArray(char ch)
    {
        ...
        if (null != hanyuPinyinStringArray)
        {
            ...
            for (int i = 0; i < hanyuPinyinStringArray.length; i++)
            {
                targetPinyinStringArray[i] = GuoyuRomazTranslator.convertHanyuPinyinToGwoyeuRomatzyh(hanyuPinyinStringArray[i]);
            }
    ...
    static public String toHanyuPinyinString(String str,
            ChinesePinyinOutputFormat outputFormat, String seperater)
            throws ChinesePinyinOutputFormatCombinationException
    {
