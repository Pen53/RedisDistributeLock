...
public class DateUtil {
    ...
    * @return
    ...
    public static Date parseDefaultDateTime(String dateTime){
        return parseDate(dateTime, FunctionConstants.FULL_DATE_TIME_FORMAT);
    }
    ...
    * @return
    ...
    public static Date parseDefaultDateTimeMin(String dateTime){
        return parseDate(dateTime,FunctionConstants.SIMPLE_DATE_TIME_FORMAT);
    }
    /**
    ...
    * @return
    ...
    public static Date parseDefaultDate(String dateTime){
        return parseDate(dateTime,FunctionConstants.SIMPLE_DATE_FORMAT);
    }
    ...
    */
    ...
    public static Date parseDefaultDateMonth(String dateTime){
        return parseDate(dateTime,FunctionConstants.SIMPLE_DATE_MONTH_FORMAT);
    }
    ...
    * @return
    ...
    public static String formatDefaultDate(Date date) {
        return formatDateByFormat(date,FunctionConstants.SIMPLE_DATE_FORMAT);
    }
    ...
    */
    ...
    public static String parseMonth(Date date) {
        return formatDateByFormat(date,FunctionConstants.SIMPLE_MONTH_FORMAT);
    }
    ...
    * @return
    ...
    public static String formatDefaultDateTime(Date date) {
        return formatDateByFormat(date,FunctionConstants.SIMPLE_DATE_TIME_FORMAT);
    }
 /**
     * 
    * 将当前时间截掉时分秒
    ...
    */
    ...
    public static Long toCompareTimeOnDay(Date endDate,Date nowDate){
         long nd = 1000 * 24 * 60 * 60l;
         // long ns = 1000;
         // 获得两个时间的毫秒时间差异
         long diff = endDate.getTime() - nowDate.getTime();
