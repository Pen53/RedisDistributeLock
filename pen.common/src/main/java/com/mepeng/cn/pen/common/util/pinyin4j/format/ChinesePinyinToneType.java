 ...
 * 
 */
public class ChinesePinyinToneType
{

    /**
     * The option indicates that hanyu pinyin is outputted with tone numbers
     */
    public static final ChinesePinyinToneType WITH_TONE_NUMBER = new ChinesePinyinToneType("WITH_TONE_NUMBER");

    /**
     * The option indicates that hanyu pinyin is outputted without tone numbers
     * or tone marks
     */
    public static final ChinesePinyinToneType WITHOUT_TONE = new ChinesePinyinToneType("WITHOUT_TONE");

    /**
     * The option indicates that hanyu pinyin is outputted with tone marks
     */
    public static final ChinesePinyinToneType WITH_TONE_MARK = new ChinesePinyinToneType("WITH_TONE_MARK");
    ...
    protected ChinesePinyinToneType(String name)
    {
        setName(name);
    }
